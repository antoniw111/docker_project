...
RUN groupadd -g ${GROUP_ID} ${USER_NAME} || true && \
    ...
    echo "source /opt/openfoam211/etc/bashrc" >> /home/${USER_NAME}/.bashrc
ENV USER=${USER_NAME}
...
RUN cd ${WM_PROJECT_USER_DIR} && git clone https://github.com/antoniw111/ddtFoam.git && \
    /bin/bash -c "source /opt/openfoam211/etc/bashrc && cd ${WM_PROJECT_USER_DIR}/ddtFoam && ./Allwmake"
